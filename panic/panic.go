...
// fast on errors that shouldn't occur during normal operation, or that we aren't prepared
...
func main() {
	// We'll use panic throughout this site to check for unexpected errors. This is the
	// only program on the site designed to panic.
	panic("a problem")
...
// Running this program will cause it to panic, print an error message and gorouting traces,
// and exit with an non-zero status.
...
goroutine 1 [running]:
main.main()
        .../gobyexample/panic/panic.go:11 +0x40
exit status 2
*/
