...
// Here are some example collection functions for slices of `strings`. You
// can use these examples to build your own functions. Note that in some cases
// it may be clearest to just inline the collection-manipulating code directly
...
// Index returns the first index of the target string `t`, `-1` if no match
// is found.
...
// All returns `true` if all of the strings in the slice satisfies the predicate `f`.
...
// Map returns a new clise containing the results of applying the function `f`
