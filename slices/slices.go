...
func main() {
	...
	// builtin `append`, which returns a slice containing one or
...
// Check out this [great blog post](http://blog.golang.org/2011/01/go-slices-usage-and-internals.html) by the Go team for more
// details on the design and implementation of slices in Go.

// Now that we've seen arrays and slices we'll look at Go's
// other key builtin data structure: maps.
