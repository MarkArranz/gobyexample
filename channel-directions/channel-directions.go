// When using channels as function parameters, you can specify if a channel is meant
// to only send or receive values. This specificity increases the type-safely of the
// program.
package main
