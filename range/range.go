...
// structures. Let's see how to use `range` with some of the
...
func main() {
	...
	// range on strings iterates over Unicode points. The
	// first value is the starting byte index of the `rune` and the
