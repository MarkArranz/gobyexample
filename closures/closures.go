...
// useful when you want to define a funciton inline without having to name it.
package main
...
func main() {
	// We'll call `intSeq`, assigning the result (a function) to `nextInt`.
	...
	// To confirm that the state is unique to that particular function, create and test
	// a new one.
	newInts := intSeq()
	fmt.Println(newInts())
}
